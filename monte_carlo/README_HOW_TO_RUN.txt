...
#Actual for test (3 Runs of each simulation)
file1=./configs/Table4_test.config
folder1=../experiments/Table4_test

#Actual for the real thing
file1=./configs/Table4.config
folder1=../experiments/Table4
...
sed -i "s:TODO:$base/:g" ./configs/Table4_test.config
sed -i "s:TODO:$base/:g" ./configs/Table4.config


MANUAL: edit ./configs/Table4.config
...
MANUAL:         I can script this up if need be
